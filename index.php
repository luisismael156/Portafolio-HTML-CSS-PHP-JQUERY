    ...
    <div class="menu">
        ...
        <div class="container">
            <div class="container-title">
                <div class="title">
                    <h1>Luis Ismael Flores Huamán</h1>
                    <h2>Desarrollador Frontend</h2>
                    <a class="btn-primary" href="">Ver mis Trabajos</a>
                </div>
            </div>
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="contain">
                    ...
                    <div class="about-text wow bounceInUp">
                        ...
                        <p>Me aseguro de utilizar siempre las últimas tecnologías de desarrollo web: HTML5,
                            CSS3(flexbox,Grid),
                            jQuery<span> una página web moderna, funcional, que se adapte a
                                todos los diferentes tipos de pantalla</span>, te aseguro que llegaste al lugar
                            correcto.</p>
                        <p>Puedes ponerte en contacto conmigo a través de Facebook, Linkedin o completando el formulario
                            de contacto que se encuentra al final de mi sitio web.</p>
                        <a class="btn-primary" href="#">Ver mis trabajos</a>
                    </div>
                </div>
            </div>
        ...
        <section id="works">
            <div class="container">
                ...
                <div class="container-works owl-carousel owl-theme">
                    <div class="work item">
                        <a href="#"> <img src="images/images-works/Mockup imac.png">
                        </a>
                        <p>Example 1</p>

                    </div>
                    <div class="work item">
                        <a href="#"> <img src="images/images-works/cookiee.png">
                        </a>
                        <p>Example 2</p>

                    </div>
                    <div class="work item">
                        <a href="#"> <img src="images/images-works/hamoria-mockup.png">
                        </a>
                        <p>Example 3</p>

                    </div>
                    <div class="work item">
                        <a href="#"> <img src="images/images-works/miumis-mockup.png">
                        </a>
                        <p>Example 4</p>

                    </div>
                    <div class="work item">
                        <a href="#"> <img src="images/images-works/sofia-mockup.png">
                        </a>
                        <p>Example 5</p>
        ...
        <section id="trabajar-conmigo">
            <div class="container">
                ...
                <div class="container-working">
                    <div class="item">
                        <ul>
                            <li><img src="images/velocidad.png"></li>
                            <h4>Velocidad</h4>
                            <li>Me aseguro de que tu web cargue entre 2 y 4 segundos
                                (depende de la cantidad de contenido del sitio).
                                Si una web tarda más de 5 segundos en cargar
                                , el 70% de los usuarios lo cierra y no vuelve a entrar más</li>

                        </ul>
                    </div>
                    <div class="item">
                        <ul>
                            <li><img src="images/mantenimiento.png"></li>
                            <h4>Asesoramiento</h4>
                            <li>Mantengo una comunicación constante con mi cliente, para enseñarle a modificar contenido
                                mediante el panel de Wordpress o para cualquier duda/cambio que quiera hacer en su sitio
                                web</li>
                    ...
                    <div class="item">
                        <ul>
                            <li><img src="images/mobile-icon.png"></li>
                            <h4>Mobile Priority </h4>
                            <li>Cada vez mas personas navegan desde sus celulares en cualquier parte del mundo. Me
                                aseguro de que tu web esté optimizada para cualquier tipo de dispositivo móvil</li>
        ...
        <section id="wordpress">
            <div class="container">
                <h3>Wordpress. Lo mejor.</h3>
                <p>Wordpress es la mejor plataforma del mundo para construir tu sitio web</p>
                <div class="container-wordpress">
                    <div class="wordpress-img">
